...
class Thing(models.Model):
    ...
    bzq = models.CharField(max_length=100, blank=True, null=True)  # 保质期
    guige = models.CharField(max_length=100, blank=True, null=True) # 规格
    status = models.CharField(max_length=1, choices=STATUS_CHOICES, default='0')
    create_time = models.DateTimeField(auto_now_add=True, null=True)
...
class Order(models.Model):
    ...
    receiver_address = models.CharField(max_length=50, blank=True, null=True)  # 送货地址
